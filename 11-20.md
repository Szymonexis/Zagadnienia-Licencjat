...
<ul>
<li><b>Publiczny</b> (public)
    <ul>
        <li>Nie ma ograniczeń</li>
        <li>Składnik posiadający ten modyfikator jest dostępny dla dowolnej klasy, czyli z poziomu dowolnego kodu</li>
    </ul>
</li>
<li><b>Prywatny</b> (private)
    <ul>
        <li>Składnik posiadający ten modyfikator jest dostępny jedynie w obrębie klasy, w której się znajduje</li>
    </ul>
</li>
<li><b>Chroniony</b> (protected)
    <ul>
        <li>Składnik posiadający ten modyfikator jest dostępny jedynie w obrębie klasy, w której się znajduje oraz w klasach dziedziczących</li>
    </ul>
</li>
</ul>
